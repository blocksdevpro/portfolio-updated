    ...
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 animate-fade-in delay-200">
      {socials.github && (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex items-center gap-2 p-2 text-muted-foreground hover:text-accent-foreground hover:bg-primary-foreground border rounded-md group"
        >
      ...
      {socials.linkedin && (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex items-center gap-2 p-2 border rounded-md text-muted-foreground hover:text-accent-foreground hover:bg-primary-foreground group"
        >
